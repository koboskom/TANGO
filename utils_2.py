...
def get_shots_data(scene_list_out, MITSU_output_path):
    """
    ...
    :param MITSU_output_path: Directory holding the output of the MITSU software
    ...
    for i, scene in enumerate(scene_list_out):
        ...
        csv_reader = csv.reader(MITSU_csv, delimiter='\t')
